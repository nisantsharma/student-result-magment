        ...
        // TODO add your handling code here:
         ...
         String OS=jTextField6.getText();
          try{
           ...
           ResultSet rs= st.executeQuery(string:"select* from student where rollno='"+roll+"'");
           if(rs.next()){
            st.executedUpdate(string:"insert into student (rollno,physic,math,em,dbms,os) values('"+roll+"','"+physics+"','"+Math+"','"+EM+"','"+DBMS+"','"+OS+"') ");
            JOptionPane.showMessageDialog(null,"add result sussfully");
            setVisible(false);
            new adminHome().setVisible(true);
           }else{
